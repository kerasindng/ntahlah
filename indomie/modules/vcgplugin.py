...
from indomie import CMD_HELP, PLAY_PIC, QUEUE_PIC, call_py
from indomie.core.vcbot import (
    CHAT_TITLE,
    gen_thumb,
    skip_current_song,
    skip_item,
...
from indomie.core.vcbot.queues import QUEUE, add_to_queue, clear_queue, get_queue
