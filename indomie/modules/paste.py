...
#
"""indomie module containing commands for interacting with dogbin(https://del.dog)"""
...
from indomie.utils.pastebin import PasteBin


@indomie_cmd(pattern="paste(?: (-d|-n|-h|-k|-s)|$)?(?: ([\s\S]+)|$)")
