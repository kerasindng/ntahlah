...
import io
import sys
from indomie import BOTLOG, BOTLOG_CHATID, CMD_HELP, UPSTREAM_REPO_URL, bot
from indomie.utils import indomie_cmd
from indomie.utils import time_formatter
import urllib
import requests
...
CMD_HELP.update({
    "random": "𝘾𝙤𝙢𝙢𝙖𝙣𝙙: `.random <item1> <item2> ... <item>`\
