...
import indomie.modules.sql_helper.blacklist_sql as sql
...
@register(outgoing=True, pattern=r"^\.addblist(?: |$)(.*)")
...
@register(outgoing=True, pattern=r"^\.listblist(?: |$)(.*)")
...
@register(outgoing=True, pattern=r"^\.rmblist(?: |$)(.*)")
...
CMD_HELP.update({"blacklist": ">`.listblist`"
