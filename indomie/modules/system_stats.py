...
from indomie.utils import IndomieDB, HOSTED_ON, indomie_version, bash, edit_or_reply, indomie_cmd
...
CMD_HELP.update(
    {
        ...
        \n\n  •  **Perintah :** `{cmd}alive` atau `{cmd}nyala`\
