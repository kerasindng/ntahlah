...
from indomie import BOTLOG, BOTLOG_CHATID
...
@indomie_cmd(pattern="mute(?: |$)(.*)")
async def spider(spdr):
    # Check if the function running under SQL mode
    try:
        from indomie.modules.sql_helper.spam_mute_sql import mute
...
async def unmoot(unmot):
    ...
    # Check if the function running under SQL mode
    try:
        from indomie.modules.sql_helper.spam_mute_sql import unmute
    except AttributeError:
...
async def muter(moot):
    try:
        ...
        from indomie.modules.sql_helper.spam_mute_sql import is_muted
    except AttributeError:
        return
