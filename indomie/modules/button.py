...
from indomie import BOT_USERNAME
from indomie import CMD_HANDLER as cmd
from indomie import CMD_HELP, tgbot
from indomie.utils import edit_delete, indomie_cmd, reply_id
...
@indomie_cmd(pattern="cbutton(?:\\s|$)([\\s\\S]*)")
async def _(event):
...
@indomie_cmd(pattern="ibutton(?:\\s|$)([\\s\\S]*)")
async def _(event):
...
CMD_HELP.update(
    {
        ...
        \n  •  **Examples : **`{cmd}cbutton test [google]<buttonurl:https://www.google.com> [Updates]<buttonurl:https://t.me/IndomieProject:same> [Channel]<buttonurl:https://t.me/IndomieStore>`\
        ...
        \n  •  **Examples : **`{cmd}ibutton test [google]<buttonurl:https://www.google.com> [Updates]<buttonurl:https://t.me/IndomieProject:same> [Channel]<buttonurl:https://t.me/IndomieStore>`\
    "
    }
)
