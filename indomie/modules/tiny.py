...
async def _(event):
    ...
    im1 = Image.open("indomie/resources/sky_blank.png")
    if ik.endswith(".tgs"):
        await event.client.download_media(reply, "indomie.tgs")
        os.system("lottie_convert.py indomie.tgs json.json")
        json = open("json.json", "r")
        jsn = json.read()
        json.close()
        jsn = jsn.replace("512", "2000")
        open("json.json", "w").write(jsn)
        os.system("lottie_convert.py json.json indomie.tgs")
        file = "indomie.tgs"
        os.remove("json.json")
