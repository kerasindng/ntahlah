...
from indomie import BOT_USERNAME, BOTLOG, BOTLOG_CHATID
from indomie import CMD_HANDLER as cmd
from indomie import CMD_HELP, bot, tgbot
from indomie.modules.sql_helper.bot_blacklists import (
    add_user_to_bl,
    check_is_black_list,
    get_all_bl_users,
    rem_user_from_bl,
)
from indomie.modules.sql_helper.bot_pms_sql import get_user_id
...
from indomie.core.logger import logging
...
async def ban_botpms(event):
    ...
    if user_id == OWNER_ID:
        return await event.reply("**Lu Mau Ngapain Anjg NgeGban Tuhan Gua? Goblok Mana Bisa Lah Anjg!!!**")
